            ...
            <Col xxl={12}>
              <div>
                <div className="d-flex justify-content-center">
                  ...
                  <BadgeButton title="Compare Markets" />
                </div>
                <h1 className="text-center p-0 m-0 mt-3 whyChooseHeading">
                  Why Choose FundedNext
                </h1>
                <p className="text-center whyChoosePara mt-2 mb-3">
              ...
              <div className="whyChooseUsTable mt-5">
                <PricingTable>
                  <thead>
                    <tr>
                      <td>
                        <p className="p-0 m-0 tableGreyHeading setFirstVariable">
                          VARIABLES
                        </p>
                      </td>
                      <td>
